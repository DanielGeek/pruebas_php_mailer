...
if(isset($_POST["submit"]))
{
    ...
    $mail->From = $_POST["email"];	                            //email del programador que envia el mensaje
    $mail->FromName = $_POST["name"];                           //nombre del programador que envia el mensaje
    $mail->AddAddress ("destino@gmail.com", 'Prueba 2');   //correo destino del programador que envia el mensaje
    $mail->Subject = "Formulario para programadores";           //Titulo del programador que envia el mensaje
    $mail->Body = $message;                                     //Cuerpo mensaje con datos del programador en formato html
    $mail->IsHTML (true);                                       //Sets message type to HTML

    $mail->IsSMTP();                                            //Sets Mailer to send message using SMTP
    $mail->Host = 'ssl://smtp.gmail.com';                       //Ahora definimos gmail como servidor que aloja nuestro SMTP
    ...
    $mail->Port = 465; 
    $mail->SMTPAuth = true; 
    $mail->Username = 'recibe@gmail.com'; 
